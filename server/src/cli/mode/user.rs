...
use crate::global::{generate_random_id, generate_uuid, is_null_or_whitespace};
use crate::structs::*;
use crate::cli::cli_structs::*;
use crate::users::user_create;

pub async fn create(arguments: HashMap<String, Command_argument>, modes: Vec<String>) -> Result<(), String> {
    ...
    println!("{}", serde_json::to_string(&Cli_user_create_response {
        error: false,
        id: Some(id),
        email: Some(email)
    }).unwrap());
