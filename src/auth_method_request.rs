...
pub async fn request_email(mut db: Connection<Db>, email: String, authentication_method: AuthMethod, remote_addr: SocketAddr) -> Result<(Request_magiclink, Connection<Db>), Box<dyn Error>> {
