...
pub async fn device_pipeline_server_oauth(required_scopes: Vec<&str>, hostname: Guarded_Hostname, jar: &indexmap::IndexMap<String, String>, remote_addr: String, headers: &Headers) -> Result<(Option<Guard_user>, Option<Guard_devices>, Option<AuthMethod>), Error_response> {
...
pub async fn device_pipeline_static_auth(required_scopes: Vec<&str>, hostname: Guarded_Hostname, jar: &indexmap::IndexMap<String, String>, remote_addr: String, headers: &Headers) -> Result<Device_pipeline_static_auth_response, Error_response> {
    ...
    return Ok(Device_pipeline_static_auth_response {
        user: Some(user),
        device: Some(device),
